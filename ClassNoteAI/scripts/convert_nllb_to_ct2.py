#!/usr/bin/env python3
"""
Convert NLLB-200 (No Language Left Behind) model to CTranslate2 format

NLLB-200 is Meta's multilingual translation model supporting 200+ languages,
with better translation quality than opus-mt for many language pairs.

Requirements:
    pip install ctranslate2 transformers sentencepiece torch

Usage:
    python convert_nllb_to_ct2.py [--output-dir OUTPUT_DIR] [--quantization INT8]
"""
...
def main():
    parser = argparse.ArgumentParser(description='Convert NLLB-200 to CTranslate2 format')
    parser.add_argument('--model', default='facebook/nllb-200-distilled-600M',
                        help='Hugging Face model name (default: facebook/nllb-200-distilled-600M)')
    parser.add_argument('--output-dir', default='./nllb-200-en-zh-ct2',
    ...
    print()
    print("Note: NLLB-200 is a large model (~2.4GB download).")
    print("The distilled-600M version is recommended for production use.")
    print()
    ...
    print()
    print("NLLB-200 Language codes:")
    print("  English: eng_Latn")
    print("  Chinese (Simplified): zho_Hans")
    print("  Chinese (Traditional): zho_Hant")
    print()
    print("To test the model:")
    print(f"  python test_nllb_ct2.py")
